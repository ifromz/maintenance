...
<section class="panel panel-default panel-grid">
    ...
    @include('work-orders.attachments.grid.templates.no-results')
    @include('work-orders.attachments.grid.templates.results')
    @include('work-orders.attachments.grid.templates.pagination')
    @include('work-orders.attachments.grid.templates.filters')
