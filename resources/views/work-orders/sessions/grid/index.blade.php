...
<section class="panel panel-default panel-grid">
    ...
    @include('work-orders.sessions.grid.templates.no-results')
    @include('work-orders.sessions.grid.templates.results')
    @include('work-orders.sessions.grid.templates.pagination')
    @include('work-orders.sessions.grid.templates.filters')
