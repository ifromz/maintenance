...
<section class="panel panel-default panel-grid">
    ...
    @include('work-orders.parts.inventory.grid.templates.no-results')
    @include('work-orders.parts.inventory.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'inventory'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'inventory'])
