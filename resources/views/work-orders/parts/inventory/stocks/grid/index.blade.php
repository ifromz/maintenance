...
<section class="panel panel-default panel-grid">
    ...
    @include('work-orders.parts.inventory.stocks.grid.templates.no-results')
    @include('work-orders.parts.inventory.stocks.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'inventory-stocks'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'inventory-stocks'])
