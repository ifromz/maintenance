<script type="text/template" data-grid="parts" data-template="pagination">
    ...
    <div class="text-center">
        ...
        <ul class="pagination pagination-sm">
            ...
            <li><a href="#" data-grid="parts" data-page="1"><i class="fa fa-angle-double-left"></i></a></li>

            <li><a href="#" data-grid="parts" data-page="<%= p.previous_page %>"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <li><a href="#" data-grid="parts" data-page="<%= i %>"><%= i %></a></li>
            ...
            <li><a href="#" data-grid="parts" data-page="<%= p.next_page %>"><i class="fa fa-chevron-right"></i></a></li>

            <li><a href="#" data-grid="parts" data-page="<%= p.pages %>"><i class="fa fa-angle-double-right"></i></a></li>
