...
<section class="panel panel-default panel-grid">
    ...
    @include('work-orders.parts.grid.templates.no-results')
    @include('work-orders.parts.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'parts'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'parts'])
