...
<section class="panel panel-default panel-grid">
    ...
    @include('admin.roles.grid.templates.no-results')
    @include('admin.roles.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'roles'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'roles'])
