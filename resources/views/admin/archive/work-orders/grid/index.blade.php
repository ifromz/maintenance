...
<section class="panel panel-default panel-grid">
    ...
    @include('admin.archive.work-orders.grid.templates.no-results')
    @include('admin.archive.work-orders.grid.templates.results')
    @include('layouts.partials.grid.templates.pagination', ['grid' => 'work-orders'])
    @include('layouts.partials.grid.templates.filters', ['grid' => 'work-orders'])
