...
{!! HTML::script('assets/mobiscroll/js/mobiscroll.util.datetime.js') !!}
{!! HTML::script('assets/mobiscroll/js/mobiscroll.datetimebase.js') !!}
{!! HTML::script('assets/mobiscroll/js/mobiscroll.datetime.js') !!}
{!! HTML::script('assets/mobiscroll/js/mobiscroll.select.js') !!}
{!! HTML::script('assets/mobiscroll/js/mobiscroll.listbase.js') !!}
