<meta charset="UTF-8">
<title>@yield('title') | {{ memorize('site.name', '') }}</title>
...
{!! HTML::style('assets/mobiscroll/css/mobiscroll.widget.css') !!}
{!! HTML::style('assets/mobiscroll/css/mobiscroll.widget.ios-classic.css') !!}
{!! HTML::style('assets/mobiscroll/css/mobiscroll.widget.ios.css') !!}

{!! HTML::style('assets/mobiscroll/css/mobiscroll.scroller.css') !!}
