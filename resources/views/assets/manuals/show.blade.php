...
@section('content')
    ...
    <div class="row text-center">
        ...
        <div class="btn-group" role="group">
            <a class="btn btn-primary btn-lg" href="{{ route('maintenance.assets.manuals.download', [$asset->id, $manual->id]) }}"><i class="fa fa-download"></i> Download</a>
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ route('maintenance.assets.manuals.edit', [$asset->id, $manual->id]) }}"><i class="fa fa-edit"></i> Edit</a></li>
                    <li>
                        <a
