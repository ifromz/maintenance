...
<section class="panel panel-default panel-grid">
        ...
        <nav class="navbar navbar-default navbar-actions">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#assets-meters-actions">
                ...
                <div class="collapse navbar-collapse" id="assets-meters-actions">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="primary">
                            <a href="{{ route('maintenance.assets.meters.create', [$asset->id]) }}" data-toggle="tooltip" data-original-title="Create">
                    ...
                    {{-- Grid: Filters --}}
                    <form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="assets-meters" role="form">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <button data-toggle="tooltip" data-original-title="Refresh" class="btn btn-default" data-grid="assets-meters" data-reset>
    ...
    <div class="table-responsive">
        ...
        <table id="assets-meters-results" class="table table-hover" data-source="{{ route('maintenance.api.v1.assets.meters.grid', [$asset->id]) }}" data-grid="assets-meters">
