...
use App\Http\Requests\WorkOrder\SessionEndRequest;
use App\Http\Requests\WorkOrder\SessionStartRequest;
use App\Repositories\WorkOrder\Repository as WorkOrderRepository;
use App\Repositories\WorkOrder\SessionRepository;
...
class SessionController extends BaseController
{
    ...
    public function index($workOrderId)
    {
        ...
        return view('work-orders.sessions.index', compact('workOrder'));
    }
