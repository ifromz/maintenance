<div class="input-group">
    ...
    <span class="input-group-btn">
    	<button class="btn btn-primary" data-toggle="modal" data-target="#inventoryCategoryModal" type="button">Select</button>
        <a href="{{ route('maintenance.inventory.categories.index') }}" class="btn btn-default" data-toggle="tooltip" data-title="Manage Categories"> Manage</a>
    </span>
</div><!-- /input-group -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="inventory-category-select" type="button" class="btn btn-primary" disabled="disabled" data-dismiss="modal">Select</button>
            </div>
