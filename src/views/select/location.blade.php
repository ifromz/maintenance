<div class="input-group">
	{{ Form::text('location', (isset($location_name) ? $location_name : NULL), array('readonly', 'class'=>'form-control', 'placeholder'=>"Click 'Select'")) }}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
                ...
                <button id="location-select" type="button" class="btn btn-primary" disabled="disabled" data-dismiss="modal">Select</button>
			</div>
		</div>
	</div>
</div>
