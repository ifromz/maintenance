...
@section('panel.head.content')
    <div class="btn-toolbar">
        <a href="{{ route('maintenance.assets.images.create', array($asset->id)) }}" class="btn btn-primary"
                ...
                <tr>
                    <td width="200">
                        <img class="img-responsive"
                             src="{{ Storage::url($image->file_path.$image->file_name) }}">
                    </td>
                    <td>{{ $image->name }}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="{{ route('maintenance.assets.images.destroy', array($asset->id, $image->id)) }}"
                                       data-method="delete"
