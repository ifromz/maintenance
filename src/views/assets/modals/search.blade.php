<div class="modal fade" id="search-modal" tabindex="-1 " role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{ Form::open(['url'=>$url, 'method'=>'GET', 'class'=>'form-horizontal ajax-form-get', 'data-refresh-target'=>'#resource-paginate']) }}
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        {{ Form::select('condition', trans('maintenance::assets.conditions'), Input::get('condition') ?: null, ['class'=>'form-control select2']) }}
                    </div>
                </div>
