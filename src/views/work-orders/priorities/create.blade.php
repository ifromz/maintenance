    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Create a new Priority</h3>
            </div>
            <div class="panel-body">
                {{ Form::open(array('url'=>route('maintenance.work-orders.priorities.store'), 'class'=>'form-horizontal ajax-form-post clear-form')) }}
