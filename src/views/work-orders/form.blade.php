...
<div class="form-group">
    ...
    <div class="col-md-4">
        {!!
            Form::textarea('description', (isset($workOrder) ? htmlspecialchars($workOrder->description) : null), ['class'=>'form-control', 'style'=>'min-width:100%','placeholder'=>'ex. Added components']) !!}
    </div>
</div>
