...
<section class="panel panel-default panel-grid">
    ...
    <div class="table-responsive">
        ...
        <table id="work-orders-results" class="table table-hover" data-source="{{ route('maintenance.api.v1.work-orders.grid') }}" data-grid="work-orders">
    ...
    @include('maintenance::work-orders.grid.templates.no-results')
    @include('maintenance::work-orders.grid.templates.results')
    @include('maintenance::layouts.partials.grid.templates.pagination', ['grid' => 'work-orders'])
    @include('maintenance::layouts.partials.grid.templates.filters', ['grid' => 'work-orders'])
