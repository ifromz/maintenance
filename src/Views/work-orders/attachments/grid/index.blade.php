...
<section class="panel panel-default panel-grid">
        ...
        <nav class="navbar navbar-default navbar-actions">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#work-order-attachments-actions">
                        <span class="fa fa-bars"></span>
                    </button>
                </div>

                {{-- Grid: Actions --}}
                <div class="collapse navbar-collapse" id="work-order-attachments-actions">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="primary">
                            <a href="{{ route('maintenance.work-orders.attachments.create', [$workOrder->id]) }}" data-toggle="tooltip" data-original-title="Upload">
                    ...
                    {{-- Grid: Filters --}}
                    <form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="work-order-attachments" role="form">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="filter" type="text" placeholder="Search">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    <button data-toggle="tooltip" data-original-title="Refresh" class="btn btn-default" data-grid="work-order-attachments" data-reset>
    ...
    <div class="panel-body">
        ...
        <div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
            ...
            <div id="work-order-attachments-filters" class="btn-group" data-grid="work-order-attachments"></div>
    ...
    <div class="table-responsive">
        ...
        <table id="work-order-attachments-results" class="table table-hover" data-source="{{ route('maintenance.api.v1.work-orders.attachments.grid', [$workOrder->id]) }}" data-grid="work-order-attachments">
    ...
    <footer class="panel-footer clearfix text-center">
        ...
        {{-- Grid: Pagination --}}
        <div id="work-order-attachments-pagination" data-grid="work-order-attachments"></div>

    </footer>

    @include('maintenance::work-orders.attachments.grid.templates.no-results')
    @include('maintenance::work-orders.attachments.grid.templates.results')
    @include('maintenance::work-orders.attachments.grid.templates.pagination')
    @include('maintenance::work-orders.attachments.grid.templates.filters')
...
<script>
    ...
    $(function()
    {
        $.datagrid('work-order-attachments', '#work-order-attachments-results', '#work-order-attachments-pagination', '#work-order-attachments-filters');
    });
