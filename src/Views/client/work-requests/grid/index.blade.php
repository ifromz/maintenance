...
<section class="panel panel-default panel-grid">
    ...
    @include('maintenance::client.work-requests.grid.templates.no-results')
    @include('maintenance::client.work-requests.grid.templates.results')
    @include('maintenance::layouts.partials.grid.templates.pagination', ['grid' => 'work-requests'])
    @include('maintenance::layouts.partials.grid.templates.filters', ['grid' => 'work-requests'])
